...
class HTMXGroupUsersListView(generic.ListView):
...
class HTMXGroupUsersCreateView(generic.CreateView):
    model = models.GroupUsers
    form_class = forms.GroupUsersForm
...
class HTMXGroupUsersDeleteView(generic.DeleteView):
    model = models.GroupUsers
    success_url = reverse_lazy("wish_chat_GroupUsers_htmx_list")
...
class HTMXGroupListView(generic.ListView):
    model = models.Group
...
class HTMXGroupCreateView(generic.CreateView):
    model = models.Group
    form_class = forms.GroupForm
...
class HTMXGroupDeleteView(generic.DeleteView):
    model = models.Group
    success_url = reverse_lazy("wish_chat_Group_htmx_list")
...
class HTMXUserDeleteView(generic.DeleteView):
    model = models.User
    success_url = reverse_lazy("wish_chat_User_htmx_list")
...
class HTMXMessageDeleteView(generic.DeleteView):
    model = models.Message
    success_url = reverse_lazy("wish_chat_Message_htmx_list")
